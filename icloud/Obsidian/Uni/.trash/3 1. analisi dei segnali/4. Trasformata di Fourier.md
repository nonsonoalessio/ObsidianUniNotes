...
2. Una [[Archivio/Anno2/Semestre1/3 1. analisi dei segnali/2.1 Operazioni sui Segnali#^b7582a|convoluzione]] in un dominio corrisponde ad un prodotto nell'altro (e viceversa).
3. Una [[Archivio/Anno2/Semestre1/3 1. analisi dei segnali/2.1 Operazioni sui Segnali#^6c8747|modulazione]] in un dominio corrisponde alla [[Archivio/Anno2/Semestre1/3 1. analisi dei segnali/2.1 Operazioni sui Segnali#^32be84|replicazione]] nell'altro (e viceversa).
4. Una [[Archivio/Anno2/Semestre1/3 1. analisi dei segnali/2.1 Operazioni sui Segnali#^1824d6|traslazione]] (di $- t_0$) corrisponde alla moltiplicazione per un fasore con fase $-2 \pi f t_0$   $$\mathscr{F} [x(t - t_0)] = e^{-j2 \pi f t_0} \mathscr{F} [x(t)]]$$
%%5.%%
